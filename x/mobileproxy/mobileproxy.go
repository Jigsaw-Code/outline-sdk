...
// NewStreamDialerFromSearch automatically selects a DNS and TLS strategy to use, and return a [StreamDialer]
...
// https://github.com/Jigsaw-Code/outline-sdk/blob/fortuna-smart/x/examples/smart-proxy/config.json
func NewStreamDialerFromSearch(testDomains *StringList, searchConfig string, logWriter LogWriter) (*StreamDialer, error) {
