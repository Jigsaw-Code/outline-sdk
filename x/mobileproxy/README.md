...
> [!WARNING]
The psiphon library is not included by default because the psiphon codebase uses GPL. To support psiphon configuration in smart-proxy please build using the `psiphon` build tag.
