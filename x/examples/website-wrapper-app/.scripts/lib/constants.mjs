...
export const WRAPPER_APP_TEMPLATE_DIR = path.join(process.cwd(),"wrapper_app_template");
...
export const WRAPPER_APP_OUTPUT_SDK_MOBILEPROXY_DIR = path.join(WRAPPER_APP_DIR, "mobileproxy");